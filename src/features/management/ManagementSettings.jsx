import { Settings, User, Shield, Globe, Zap, Database, Bell } from 'lucide-react'
  ...
  return (
    <div className="p-6 max-w-[800px] mx-auto space-y-5">
      <div>
        ...
        <p className="text-[12px] text-text-secondary mt-0.5">System configuration and management preferences</p>
      </div>
      ...
      <div className="bg-surface border border-border rounded-lg p-5">
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-between p-3 bg-elevated rounded-md">
            <span className="text-[13px]">API Rate Limiting</span>
            <span className="text-[12px] text-success">Enabled</span>
          </div>
        </div>
      </div>
      ...
      <div className="bg-surface border border-border rounded-lg p-5">
        ...
        <div className="space-y-2">
          <NavLink to="/management/ai/provider" className="flex items-center justify-between p-3 bg-elevated hover:bg-raised rounded-md transition-colors">
            <span className="text-[13px]">Provider Settings</span>
            <span className="text-[12px] text-accent">Configure</span>
          </NavLink>
          <NavLink to="/management/ai/prompts" className="flex items-center justify-between p-3 bg-elevated hover:bg-raised rounded-md transition-colors">
            <span className="text-[13px]">Prompt Templates</span>
            <span className="text-[12px] text-accent">Manage</span>
          </NavLink>
          <NavLink to="/management/ai/health" className="flex items-center justify-between p-3 bg-elevated hover:bg-raised rounded-md transition-colors">
            <span className="text-[13px]">System Health</span>
            <span className="text-[12px] text-accent">Monitor</span>
          </NavLink>
        </div>
      </div>
      ...
      <div className="bg-surface border border-border rounded-lg p-5">
        ...
        <div className="space-y-2">
          <a href="/admin" className="flex items-center justify-between p-3 bg-elevated hover:bg-raised rounded-md transition-colors">
            <span className="text-[13px]">Admin Panel</span>
            <span className="text-[12px] text-accent">/admin</span>
          </a>
